...
To learn more about Crate and Docker visit our [Docker page at Crate.io](https://crate.io/c/docker).
You can also contact us on [Slack](https://crate.io/docs/support/slackin/).


## How to use this image

Simply run the latest Crate version in a Docker container with the following command.

```console
$ docker run -d -p 4200:4200 -p 4300:4300 crate:latest
```

Crate ships with an [Admin UI](https://crate.io/docs/connect/admin_ui/) that provides an overview of your cluster, nodes, tables and much more. With the above command it is accessible via port 4200.
...
To use your custom [Crate configuration](https://crate.io/docs/reference/configuration.html) file use the following parameter.
